            ...
            <div class="col-md-12">
                <div class="card text-center">
                  ...
                  <div class="card-body">
                    ...
                    <div v-else class="alert alert-warning">T
                        <p>There is no any activitie for the user</p>
                        <router-link :to="{ name: 'questions.create' }">Create a new question</router-link>
                    </div>
                  </div>
                </div>
            </div>
